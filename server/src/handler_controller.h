...
bool route_is_unavailable_or_conflicted(int route_id);
bool route_is_clear(int route_id, const char *train_id);
bool set_route_points_signals(int route_id);
bool block_route(int route_id, const char *train_id);
